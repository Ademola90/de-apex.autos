...
const CarHireManagement = () => {
  ...
  const handleStatusChange = async (id, status) => {
    try {
      ...
      toast.update(toastId, {
        render: "Car status updated successfully",
        type: "success",
        isLoading: false,
        autoClose: 3000,
      });
  ...
  const handleViewCar = (id) => {
    // Navigate to the view car page
    navigate(`/admin/view-hire-car/${id}`);
  };

  const handleEditCar = (id) => {
    // Navigate to the edit car page
    navigate(`/admin/edit-hire-car/${id}`);
  };
