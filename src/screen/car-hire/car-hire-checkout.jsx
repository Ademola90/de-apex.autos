...
const CarHireCheckout = () => {
  ...
  const [currentStep, setCurrentStep] = useState(1); // 1: Personal Info, 2: Payment
        ...
        <div className="mb-8">
          <div className="flex items-center justify-center">
            <div className="flex items-center">
              ...
              <div className="text-sm font-medium ml-2">Personal Info</div>
            </div>
            <div
              className={`w-16 h-1 mx-2 ${
                currentStep >= 2 ? "bg-mainBlue" : "bg-gray-200"
              }`}
            ></div>
            <div className="flex items-center">
              <div
                ...
                {currentStep === 2 && (
                  <>
                    ...
                    <div className="flex justify-between mt-6">
                      ...
                      <button
                        type="submit"
                        className="px-6 py-2 bg-mainBlue text-white rounded-md hover:bg-blue-700 transition duration-300 flex items-center justify-center"
