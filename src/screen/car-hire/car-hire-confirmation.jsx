                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      <p>Base: ₦{bookingDetails.basePrice.toLocaleString()}</p>
                      {bookingDetails.chauffeurFee > 0 && (
                        <p>
                          Driver: ₦
                          {bookingDetails.chauffeurFee.toLocaleString()}
                        </p>
                      )}
                      <p>
                        Distance: ₦
                        {bookingDetails.distancePrice.toLocaleString()}
                      </p>
