      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="lg:w-1/2 md:w-full w-full h-full lg:items-center md:items-center grid">
          <div className="lg:px-20 md:px-10 px-8">
            <p className="text-center lg:text-4xl md:text-4xl text-3xl font-Poppins font-bold">Verify Email Address</p>
            ...
            <div className="mt-3">
              ...
              <div className="flex justify-center items-center gap-3 mt-3" onPaste={handlePaste}>
                {otp.map((digit, index) => (
                  <input
                    key={index}
                    type="text"
            ...
            <div className="justify-center flex items-center mt-5">
              <Buttons
                ...
                css="bg-mainBlue text-whiteColor font-Poppins text-base font-normal px-4 py-2 hover:scale-105 ease-in duration-300"
                text="Verify Email"
              />
            </div>
            ...
            <div className="text-center mt-4">
              <p className="text-sm text-gray-600">
                ...
                <button onClick={handleResendOTP} className="text-mainBlue hover:underline focus:outline-none">
                  Resend OTP
                </button>
              </p>
            </div>
