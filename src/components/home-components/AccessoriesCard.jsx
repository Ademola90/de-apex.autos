  ...
  const accessories = [
    {
      ...
      name: "Car Seat Cover",
      price: "$19.99",
      text: "Comfortable and durable seat cover.",
    },
            ...
            <div className="">
              ...
              <div className="flex items-center gap-4 mt-2">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleLike(accessory.id);
                  }}
                >
                  <IoHeart
                    className={`text-2xl ${
                      likes[accessory.id] ? "text-red-500" : "text-gray-400"
                    }`}
                  />
                </button>
                <div className="flex items-center gap-1">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      handleRating(accessory.id);
                    }}
                  >
                    <FaStar
                      className={`text-2xl ${
                        ratings[accessory.id]
                          ? "text-yellow-500"
                          : "text-gray-400"
                      }`}
                    />
